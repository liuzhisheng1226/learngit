...
MODELS_DIR = '/home/sensetime/point-master/caffe/models/fcn-32s-pascal/'
...
def set_up_parser():
	...
	parser.add_option("--train-img", dest="train_img", default="/media/sensetime/64C43C54C43C2AA6/lmdb/train_im_full")
	parser.add_option("--train-gt", dest="train_gt", default="/media/sensetime/64C43C54C43C2AA6/lmdb/train_gt_point")
	parser.add_option("--val-img", dest="val_img", default="/media/sensetime/64C43C54C43C2AA6/lmdb/val_im_full")
	parser.add_option("--val-gt", dest="val_gt", default="/media/sensetime/64C43C54C43C2AA6/lmdb/val_gt_full")
...
def update_train_val(options):
	...
	for line in fileinput.FileInput(filename, inplace=1):
		if options.test:
			line = line.replace('/media/sensetime/64C43C54C43C2AA6/lmdb/train_im_full', options.train_img)
			line = line.replace('/media/sensetime/64C43C54C43C2AA6/lmdb/train_gt_point', options.train_gt)
			line = line.replace('/media/sensetime/64C43C54C43C2AA6/lmdb/val_im_full', options.val_img)
			line = line.replace('/media/sensetime/64C43C54C43C2AA6/lmdb/val_gt_full', options.val_gt)
